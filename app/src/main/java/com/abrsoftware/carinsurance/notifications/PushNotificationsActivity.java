...
import com.abrsoftware.carinsurance.login.LoginActivity;
import com.google.firebase.FirebaseApp;
import com.google.firebase.auth.FirebaseAuth;
import com.google.firebase.messaging.FirebaseMessaging;

import static com.abrsoftware.carinsurance.R.id.notifications_container;

public class PushNotificationsActivity extends AppCompatActivity {
    private String TAG = PushNotificationsActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(getString(R.string.title_activity_push_notifications));
